import { z } from "zod";
import { getAdminAuditLogs, getAdminOrder, getAdminOverviewStats, getAdminUser, listAdminOrders, listAdminTickets, listAdminUsers, loginAdmin, resendOrderEmail, updateAdminOrderStatus, updateAdminUser, verifyTicketCode, } from "../services/admin.service.js";
 ...
 */
export async function listAdminOrdersController(req, res) {
    try {
 ...
 */
export async function getAdminOrderController(req, res) {
    try {
 ...
 */
export async function resendOrderEmailController(req, res) {
    try {
        const orderId = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
        const adminId = req.user?.userId;
 ...
 */
export async function listAdminTicketsController(req, res) {
    try {
        const search = req.query.search;
        const limit = req.query.limit ? parseInt(String(req.query.limit), 10) : 50;
        const offset = req.query.offset ? parseInt(String(req.query.offset), 10) : 0;
 ...
 */
export async function verifyTicketCodeController(req, res) {
    try {
 ...
 */
export async function getAdminUserController(req, res) {
    try {
 ...
 */
export async function uploadAdminMediaController(req, res) {
    try {
 ...
 */
export async function getAdminAuditLogsController(req, res) {
    try {
        const limit = req.query.limit ? parseInt(String(req.query.limit), 10) : 50;
